...
void _create() {
  ...
  var largeColorPicker = new Colorize(256);
  ...
  var smallColorPicker = new Colorize(128, showInfoBox: false, initialColor: new ColorValue.fromRGB(60, 190, 220));
  ...
  var tinyColorPicker = new Colorize(64, showInfoBox: false);
